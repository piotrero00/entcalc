function [result] = ge_mixed_ra_gr(kets,ps, dim,sdpaccuracy,itera)
...
%Contrary to ge_mixed_gr this function accepts input as a ensemble of orthogonal kets not a density matrix.
...
% ge_mixed_ra_gr({GHZ,W},[0.6,0.4], [2,2,2])
% ans =
%    [0.3025,1.0000]
   ...
   %Main part of the function
    ...
    cvx_begin sdp
        ...
        partialTrace_X = PartialTrace(X, 2, [rank, producta]);
